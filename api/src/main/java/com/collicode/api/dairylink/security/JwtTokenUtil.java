...
import static com.collicode.api.dairylink.domain.config.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.collicode.api.dairylink.domain.config.Constants.SIGNING_KEY;
